  ...
  return (
    <>
      ...
      <motion.nav
        ...
        style={{
          background: "linear-gradient(120deg, #0A0F2C, #0F1A42)",
          borderBottom: "1px solid #334155",
        }}
      >
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between text-white text-[16px]">
          {/* Logo */}
          <div className="relative flex items-center text-xl font-bold cursor-pointer group">
            {/* Bird SVG with gradient fill and tail overlapping text */}
            <svg
